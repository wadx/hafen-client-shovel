...
public class CharWnd extends Window {
    ...
    public static final Text.Furnace catf = new BlurFurn(new Text.Foundry(Text.sans, 25).aa(true), 3, 2, new Color(96, 48, 0));
	...
	if(place == "study") {
	    ...
	    this.quest = (Quest.Info)incomingChild;
	    questbox.add(incomingChild, Coord.z);
