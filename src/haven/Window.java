...
public class Window extends Widget implements DTarget {
    ...
    public static final Coord tlm = new Coord(18, 30), brm = new Coord(13, 22), cpo = new Coord(38, 14);
    ...
    public static final Text.Furnace cf = new Text.Imager(new Text.Foundry(Text.sans, 15).aa(true)) {
